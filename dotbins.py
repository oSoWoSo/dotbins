...
def main() -> None:
    ...
    parser.add_argument(
        "--tools-dir", type=str, help=f"Tools directory (default: {TOOLS_DIR})"
    )
    ...
    update_parser.add_argument(
        "tools", nargs="*", help="Tools to update (all if not specified)"
    )
    update_parser.add_argument(
        "-p", "--platform", choices=PLATFORMS, help="Only update for specific platform"
    )
    update_parser.add_argument(
        "-a",
        "--architecture",
    ...
    update_parser.add_argument(
        "-f", "--force", action="store_true", help="Force update even if binary exists"
    )
    update_parser.add_argument(
        "-s",
        "--shell-setup",
    ...
    analyze_parser = subparsers.add_parser(
        "analyze", help="Analyze GitHub releases for a tool"
    )
    analyze_parser.add_argument(
        "repo", help="GitHub repository in the format 'owner/repo'"
    )
